...
<p>
  ...
  When the computer tries to interact with any host’s name on the Network, whether it's browsing to it or trying to ping it, the computer will first check its **Local DNS Cache** **(*Stored in Memory*)** for **Speed**❕️,
